...
class PersonalBottomSheet extends StatelessWidget {
  const PersonalBottomSheet({super.key,required this.cubit, required this.folder,});
  final dynamic cubit;
  final String folder;
  @override
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          InkWell(
            onTap: ()async{
              await cubit.getPersonalOrBackgroundImage(context,folder:folder);
            },
            child: Card(
              child: Padding(
          ...
          InkWell(
            onTap: () async {
              await cubit.picPersonalOrBackgroundImage(context,folder:folder,);
            },
            child: Card(
              child: Padding(
                padding: EdgeInsets.symmetric(vertical: sizeConfig.defaultSize*2,horizontal: sizeConfig.defaultSize*3),
